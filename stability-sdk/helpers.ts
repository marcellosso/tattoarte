import * as Generation from './generation_pb';
import { GenerationServiceClient } from './generation_pb_service';
import { grpc as GRPCWeb } from '@improbable-eng/grpc-web';
import { ArtifactTypeMap, FinishReasonMap } from './generation_pb';
...
export async function onGenerationComplete(response: GenerationResponse) {
